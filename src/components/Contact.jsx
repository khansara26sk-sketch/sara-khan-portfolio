...
import { FiSend, FiUser, FiMail, FiMessageSquare, FiActivity } from "react-icons/fi";
      ...
      <AnimatePresence>
        {loaded && currentFrameIdx >= 120 && (
          ...
          >
            ...
            >
              <input type="hidden" name="to_email" value="khansara26sk@gmail.com" />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-3">
                  <label className="text-[9px] font-mono font-bold uppercase tracking-[0.3em] text-cyan-500/50 block ml-1">NAME</label>
                  <input
                    name="name"
                    type="text"
                ...
                <div className="space-y-3">
                  <label className="text-[9px] font-mono font-bold uppercase tracking-[0.3em] text-cyan-500/50 block ml-1">EMAIL</label>
                  <input
                    name="email"
                    type="email"
              ...
              <div className="space-y-3">
                <label className="text-[9px] font-mono font-bold uppercase tracking-[0.3em] text-cyan-500/50 block ml-1">MESSAGE</label>
                <textarea
                  name="message"
              ...
              <div className="flex justify-center text-center text-[9px] font-mono uppercase tracking-[0.2em] text-cyan-400/70">
                <a href="mailto:khansara26sk@gmail.com" className="hover:text-cyan-300 transition-colors">khansara26sk@gmail.com</a>
              </div>
            </form>
          </motion.div>
        )}
