  ...
  const Aboutdata = [
    {
      icon: <FiCode size={20} />,
      title: "Languages",
      desc: "HTML, CSS, JS, React, FastAPI, SQL, Python, C; currently learning Java",
    },
    {
      icon: <FiBookOpen size={20} />,
      title: "Education",
      desc: "B.Tech CSE (AIML) — Pursuing",
    },
    {
        ...
        <div className="relative z-[50] w-full lg:w-[80%] flex flex-col md:flex-row items-center justify-end">
            ...
            <div className="w-full lg:w-[65%] flex flex-col space-y-10 pointer-events-auto bg-black/40 backdrop-blur-sm p-8 md:p-12 border border-white/5 rounded-2xl">
                ...
                <div className="robotic-section">
                    <div className="text-gray-400 text-sm md:text-md lg:text-xl font-light leading-relaxed max-w-2xl space-y-4">
                        <p>I am an aspiring AI/ML Engineer and Full Stack Developer dedicated to building intelligent, scalable, and user-centric digital solutions.</p>
                        <p>Passionate about transforming innovative ideas into impactful technology through continuous learning and modern development.</p>
                    </div>
                </div>
